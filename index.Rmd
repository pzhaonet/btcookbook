--- 
title: "TNT 擂台赛"
subtitle: Tidyverse vs. Non-Tidyverse
author: "大鹏（编）"
date: "`r Sys.Date()`"
...
为了避免不必要的误会和纷争，这个项目[改名](https://d.cosx.org/d/420808-ggplot/15) 为 Tidyverse vs. Non-Tidyverse (TNT) 擂台赛，这总容易界定了吧。希望因改名而淡化一些火药味。学习为主。欢迎有志之士加入一起完成。
...
[题目](https://d.cosx.org/d/420762)：数据框 mtcars，对满足某些条件比如行 2 到 5、列为 'cyl' 的数据进行重写，重写的条件为如果该值小于 6 就重写为 2。
...
# 后记^[原载 openr.org，原标题为“当时尚有 R base，何事纷纷说 tidyverse”] {-}
